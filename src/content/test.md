...
This paragraph exists to test **bold text**, *italic text*, ~~strikethrough text~~, and `inline code`. It also contains a [link to google](https://www.google.com/) to check link color and hover state.
